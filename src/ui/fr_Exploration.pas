...
procedure TExplorationFrame.ConnectRuntime(aRuntime: TSimRuntime; aEvents: TNotificationEvents);
begin
  fRuntime := aRuntime;
...
procedure TExplorationFrame.DisconnectRuntime(aRuntime: TSimRuntime; aEvents: TNotificationEvents);
begin
